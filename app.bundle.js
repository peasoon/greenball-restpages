...
;// CONCATENATED MODULE: ./project/index.js
...
if (document.documentElement.id === "pageAbout") {
  var swiperAbout = new core(".fam-swiper", {
    loop: true,
    pagination: {
      el: ".fam-pagination"
    },
...
if (document.documentElement.id === "pageNovelties") {
  var novSelect = document.querySelector("#novSelect");
  var choises = new choices(novSelect, {
    allowHTML: true,
    searchEnabled: false
  });
...
if (document.documentElement.id === "pageActions") {
  var selects = document.querySelectorAll(".actions-select-item");
...
if (document.documentElement.id === "pageBusiness") {
  var swiperBusiness = new core(".css-swiper", {
    loop: true,
    slidesPerView: 2,
    spaceBetween: 20,
    // pagination: {
